...
<div id = "upperleft-content">
  <h2 class = "upper"><a class = "niga" href = "index.php">Home</a> > <a class = "niga" href ="Categories.php">All Categories</a> > Physical education needs </h2>
</div>
  ...
  <li><a href= "Physical education needs.php" ><font color = "#FA4F4F"><b>Physical education needs</b></font></a></li>
  </ul>
...
mysqli_select_db($con, 'online_bidding') or die ("cannot connect to db");
                ...
                $qry="select * from sell where category = 'Physical education needs' ORDER by id desc";
