...
<div id = "upperleft-content">
  <h2 class = "upper"><a class = "niga" href = "index.php">Home</a> > <a class = "niga" href ="Categories.php">All Categories</a> > Instruments </h2>
</div>
  ...
  <li><a href= "Instruments.php" ><font color = "#FA4F4F"><b>Instruments</b></font></a></li>
...
mysqli_select_db('online_bidding') or die ("cannot connect to db");
                ...
                $qry="select * from sell where category = 'Instruments' ORDER by id desc";
