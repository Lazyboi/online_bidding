...
<link rel="stylesheet type = "text/css" href="css/adminnotif.css">
...
echo '<div class = "delete"><form action ="functions/admindeletenotif.php" method = "POST"><input class = "text" type= "text" name = "delete" value = "'.$ID.'"><button  class = "delete">Delete</button></form></div>';
...
echo '<div class = "accept"><form action ="bidders.php" method = "POST"><input class = "text" type= "text" name = "ID" value = "'.$ID.'"><button class ="accept">VIEW  BIDDERS</buton></form></div>
</div>';
...
<h3 class ="notif">LIST OF ITEMS</h3>	
...
<ul>
  ...
  <li class ="message"><a href = "adminmessages.php"><img class ="message" src = "images/message.png"></a></li>
    <li class ="notif"><a href = "adminnotif.php"><img class ="notif" src = "images/item.png"></a></li>
</ul> 
</div>
