...
<div id = "upperleft-content">
  <h2 class = "upper"><a class = "niga" href = "index.php">Home</a> > <a href ="Categories.php"><font color = "#333;">Categories</font></a>
</div>
  ...
  <ul>
  <li><a href = "Categories.php"><font color = "#FA4F4F"><b>Categories</b></font></a></li>
...
mysqli_select_db($con, 'online_bidding') or die ("cannot connect to db");
                ...
                $qry="select * from sell ORDER by id desc";
