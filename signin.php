...
<label class = "admin">
<a href = "admin.php"><img class = "admin" src = "images/admin.png"></a>
<a class ="admin" href = "admin.php">CLICK TO SIGN IN AS ADMIN</a>
</label>
<div class = "top">
<h4 class = "dont">Home</h4><a  class = "dont" href = "index.php">Back</a> 
<h2 class = "signup"> User Login</h2>

<article class = "free">  It's Free to Register in this website, Register Now!</article>
</div>
<div id ="contentmid">
<div class = "maincontent">
<article class = "user">Your Username </article>
<input type = "textbox" name = "username" placeholder = "Email or Username" required = "required">
<article class = "pass">Your Password </article>
